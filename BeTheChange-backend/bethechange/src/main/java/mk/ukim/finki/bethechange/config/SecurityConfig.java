...
import mk.ukim.finki.bethechange.config.jwt.JwtEntryPoint;
import mk.ukim.finki.bethechange.config.jwt.JwtTokenFilter;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/auth/register", "/auth/login", "/auth/current-user",
                        "/api/campaign/all", "/api/campaign/{id}", "/api/campaign/**","/user/**").permitAll()
